...
async def approve_chat(c, q):
    ...
    try:
        await q.message.edit(f"#ɴᴇᴡ_ᴊᴏɪɴ\n✨ᴛʜɪꜱ {m.from_user.mention} ᴜsᴇʀ Jᴏɪɴ ʀᴇǫᴜᴇsᴛ ʜᴀs ʙᴇᴇɴ ᴀᴄᴄᴇᴘᴛᴇᴅ ʙʏ {q.from_user.mention}")
...
async def decline_chat(c, q):
    i, user = q.data.split("_")
    try:
        await q.message.edit(f"#ᴅᴇᴄʟɪɴᴇᴅ\n💔ᴛʜɪꜱ {m.from_user.mention} ᴜsᴇʀ Jᴏɪɴ ʀᴇǫᴜᴇsᴛ ʜᴀs ʙᴇᴇɴ ᴅᴇᴄʟɪɴᴇᴅ ʙʏ {q.from_user.mention}")
